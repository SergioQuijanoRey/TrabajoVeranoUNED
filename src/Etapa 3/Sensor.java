...
public abstract class Sensor{
    ...
    Sensor(int id, double valorMaximo){
        ...
        // Instancio la lista de mediciones del sensor
    ...
    /**
     * Getter del valor maximo del sensor
     * */
    ...
    /**
     * Getter de los valores medidos del sensor
     * */
    ...
    /**
     * Getter del ultimo valor registrado del sensor
     * */
    ...
    public void setValorUltimo(double valorUltimo){
        ...
        if(this.valorUltimo > this.valorMaximo * porcentajeMaximo){
    ...
    //==========================================================================
    /**
     * Se añade una medicion al instrumento
     *
