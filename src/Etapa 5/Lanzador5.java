...
public class Lanzador5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Valor máx de CO2 en la estación de " + estacionBarcelona.getLocalizacion().getNombre()
                + ": " + estacionBarcelona.valorMasAlto(UnidadMedida.MG_CO2_M3));

        // Presentamos por pantalla el valor medio de CO2 registrado por todos los
        // sensores en Barcelona

        System.out.println("Valor medio de CO2 en la estación de " + estacionBarcelona.getLocalizacion().getNombre()
                + ": " + estacionBarcelona.valorMedio(UnidadMedida.MG_CO2_M3));

        // Presentamos por pantalla el valor medio y el valor más alto registrado por
        // todas las estaciones que gestiona el gestor medioambiental para la nueva
        // medida

        System.out.println("Valor medio de CO2 registrado en las estaciones gestionadas por el gestor medioambiental: "
                + gestor.valorMedio(UnidadMedida.MG_CO2_M3));

        System.out.println("Valor máximo de CO2 registrado en las estaciones gestionadas por el gestor medioambiental: "
                + gestor.valorMasAlto(UnidadMedida.MG_CO2_M3));
